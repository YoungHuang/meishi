			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="area.district.label" default="District" /></th>
				...
				<g:each in="${areaInstanceList}" status="i" var="areaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${areaInstance.id}">${fieldValue(bean: areaInstance, field: "district")}</g:link></td>
